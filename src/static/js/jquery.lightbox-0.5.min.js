 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({maxWidth :0, maxHeight : 0,overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'images/lightbox-ico-loading.gif',imageBtnPrev:'images/lightbox-btn-prev.gif',imageBtnNext:'images/lightbox-btn-next.gif',imageBtnClose:'images/lightbox-btn-close.gif',imageBlank:'images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
...
if ( objImagePreloader.width > settings.maxWidth ) {
        ...
        } else if ( objImagePreloader.height > settings.maxHeight ){
...
jQuery('#lightbox-image').css('height', intImageHeight + 'px');
jQuery('#lightbox-image').css('width', intImageWidth + 'px');
};
